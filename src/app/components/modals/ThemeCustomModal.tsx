...
const PRESETS: ThemePreset[] = [
    ...
    // ── Thèmes clairs ──────────────────────────────────────────────────────────
    {
        ...
        ...T(
            { ...base('0 0% 100%', '0 0% 11%'), ...palette('259 94% 51%','0 0% 100%','314 100% 47%','0 0% 100%','174 75% 46%','0 0% 100%'), ...muted('0 0% 94%','0 0% 40%'), ...borders('0 0% 87%','259 94% 51%') },
            { ...base('259 20% 11%', '259 10% 88%'), ...palette('259 80% 70%','259 20% 11%','314 70% 60%','259 20% 11%','174 75% 60%','259 20% 11%'), ...muted('259 15% 18%','259 10% 58%'), ...borders('259 15% 22%','259 80% 70%') }
        ),
    },
    {

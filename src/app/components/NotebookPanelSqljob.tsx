 ...
 * - NavBar (logo, onglets de pages, export/import, run all, bouton switch)
 * - PageContent (groupes + cellules)
 * - StatusBar (messages loading/success/error)
 *
 * Utilisé par NotebookPanel (wrapper) qui gère le switch avec NotebookPanelSqlrooms.
 */
...
// ─── Navbar ───────────────────────────────────────────────────────────────────
function NavBar({ onSwitchPanel }: { onSwitchPanel: () => void }) {
    const {
...
// ─── NotebookPanelSqljob ──────────────────────────────────────────────────────
export const NotebookPanelSqljob = ({ onSwitchPanel }: { onSwitchPanel: () => void }) => {
    return (
        <>
            <NavBar onSwitchPanel={onSwitchPanel} />

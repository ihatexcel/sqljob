 ...
 *
 * Sections :
 * - Dropzone : import de fichiers ad hoc
 * - Fichiers : fichiers chargés (cells source + dropzone)
 * - Arborescence des tables DuckDB (TableStructurePanel)
 */
import { RoomPanel, useBaseRoomShellStore } from '@sqlrooms/room-shell'
...
import { FolderIcon, FileTextIcon, XIcon, UploadIcon, DatabaseIcon } from 'lucide-react'
            ...
            <div className="shrink-0 border-b border-border">
                <Accordion type="single" collapsible defaultValue="files">
                    <AccordionItem value="files">
                        <AccordionTrigger className="gap-1 px-3 py-2">

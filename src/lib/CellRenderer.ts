                    ...
                    <div class="flex justify-between items-center py-2 px-4 bg-base-200 border-b border-base-300 cell-header-responsive" x-show="devMode">
                        ...
                        <div class="flex gap-1 items-center">
                            <div class="join">
                                ...
                                <button class="btn btn-xs join-item" @click="openChildGroupModal(${pathExpr}, ${cellIdxExpr})" title="Groupe enfant"><span class="iconify" data-icon="material-symbols-light:export-notes-outline-sharp" style="font-size:1rem"></span></button>

...
export const CELL_TYPE_SCHEMAS = {
            ...
            types: {
                ...
                sqlRecursiveParse: {
                    ...
                    hideInViewMode: true,
                    exportFields: ['queries'],
                    initProps: { _showParsedQuery: false },
                    commonParams: ['name', 'queries'],
                    queryCount: 1,
                    queryNames: ['main'],
                    specificParams: [
                ...
                publipostageWord: {
                    ...
                    initProps: { _showParsedQuery: false, _showParsedQuery2: false, _parseLevels: [], _parseLevels2: [], _isDragging: false },
                ...
                pdfme: {
                    ...
                    initProps: { _showParsedQuery: false, _parseLevels: [] },
                ...
                perspective: {
                    ...
                    initProps: { _showParsedQuery: false, _perspectiveReady: false, _perspectiveWorker: null, _perspectiveTable: null, _arrowTable: null },
                    commonParams: ['name', 'queries'],
                    queryCount: 1,
                    queryNames: ['main'],

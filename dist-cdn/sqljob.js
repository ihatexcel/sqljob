    ...
    return ["B1", "B2", "B3"];
      ...
      show(t) {
        return new Promise((e) => {
          this._resolve = e, this.message = t, this.isOpen = !0;
        });
      },
      confirm() {
        var t;
        this.isOpen = !1, (t = this._resolve) == null || t.call(this, !0), this._resolve = null;
      },
      cancel() {
        var t;
        this.isOpen = !1, (t = this._resolve) == null || t.call(this, !1), this._resolve = null;
      }
    });
  });
}
...
function pagesMixin() {
  return {
    ...
    async deletePage(t) {
      ...
      await Alpine.store("confirmModal").show(`Supprimer la page "${this.pages[t].name}" ?`) && (this.pages.splice(t, 1), this.activePageIndex >= this.pages.length && (this.activePageIndex = this.pages.length - 1));
    },
...
FROM source1 LIMIT 10;`;
    ...
    async deleteGroupAtPath(t) {
      if (!(!t || t.length === 0) && await Alpine.store("confirmModal").show("Supprimer ce groupe et tout son contenu ?")) {
        if (t.length === 1)
